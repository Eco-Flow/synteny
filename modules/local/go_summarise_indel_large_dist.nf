process GO_SUMMARISE_INDEL_LARGE_DIST {

    label 'process_single'
    tag "summary of go s"
    container = 'quay.io/ecoflowucl/chopgo:r-4.3.2_python-3.10_perl-5.38'
    publishDir "$params.outdir/output_data/go_results/summarise/indellargedist" , mode: "${params.publish_dir_mode}", pattern:"*.tsv"
