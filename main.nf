...
include { GO_SUMMARISE_JUNCTION as GO_SUMMARISE_INVER } from './modules/local/go_summarise_junctions.nf'
include { GO_SUMMARISE_JUNCTION as GO_SUMMARISE_TRANS } from './modules/local/go_summarise_junctions.nf'
include { SUMMARISE_PLOTS } from './modules/local/summarise_plots.nf'
include { SUMMARISE_PLOTS_JUNCTIONS as SUMMARISE_PLOTS_INVER } from './modules/local/summarise_plots_junctions.nf'
include { SUMMARISE_PLOTS_JUNCTIONS as SUMMARISE_PLOTS_TRANS } from './modules/local/summarise_plots_junctions.nf'
