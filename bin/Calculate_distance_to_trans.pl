...
my @translocation_files = bsd_glob("*.*.Translocation_gene_boundaries.txt");
...
foreach my $bed_file (@bed_files) {
    ...
    # Print the results
    open my $output_fh, '>', "$species\.$sp2\.translocation_gene_scores.txt" or die "Could not open output file: $!";
